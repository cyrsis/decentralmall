...
class AppGradient {
  ...
  static final LinearGradientAquaTopToBottomRight = new LinearGradient(colors: [
    Color(getColorHexFromStr("2DC9EB")),
    Color(getColorHexFromStr("14D2B8"))
  ...
  static final LinearGradientBlush = new LinearGradient(colors: [
    Color(getColorHexFromStr("FF8298")),
    Color(getColorHexFromStr("FFA073"))
  ], begin: Alignment.centerLeft, end: Alignment.centerRight);
  ...
  static final LinearGradient AppBarLinearWarmGradient = new LinearGradient(
      colors: [
        Color(getColorHexFromStr("FAD0C4")),
        Color(getColorHexFromStr("FF9A9E"))
      ],
  ...
  static final LinearGradient AppBarLinearNightFadeGradient =
      new LinearGradient(
          colors: [
            Color(getColorHexFromStr("FBC2EB")),
            Color(getColorHexFromStr("A18CD1"))
          ],
